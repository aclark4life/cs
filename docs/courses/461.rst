...
A Flex lexer (``scan.l``), evolved through several iterations of increasing complexity,
...
Low-level homework programs (``alloca.c``, ``malloc.c``) stress-testing memory
...
A program (``stat.c``), evolved through several iterations, builds a utility that
