From gfurr @csmaster.loyola.edu Wed Jan 29 19 : 39 : 02 1997 Return -
    Path : <gfurr @csmaster.loyola.edu> Received
    : from wisdom.loyola.edu by csmaster.loyola.edu(SMI - 8.6 / SMI -
                                                    SVR4) id TAA03369;
Wed, 29 Jan 1997 19 : 39 : 02 - 0500 Received
    : by wisdom.loyola.edu(SMI - 8.6 / SMI - SVR4) id TAA02482;
Wed,
    29 Jan 1997 19 : 44 : 16 -
        0500 From : gfurr @csmaster.loyola.edu(Gwennie Furr) Message -
        Id : <199701300044.TAA02482 @wisdom.loyola.edu> Subject : tokens.h To
    : aclark @csmaster(foo | sj) Date : Wed,
    29 Jan 1997 19 : 44 : 15 - 0500(EST)X
        - Mailer : ELM[version 2.4 PL25] MIME - Version : 1.0 Content -
                   Type : text / plain;
charset = US - ASCII Content - Transfer - Encoding : 7bit Content -
          Length : 5877 Status : OR
